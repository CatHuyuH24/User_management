#!/usr/bin/env python3
"""
Unified script to create default users for the User Management System
Creates:
...
# Set environment variable to use localhost for database
...
try:
    ...
    print("Make sure all dependencies are installed and Docker services are running")
    sys.exit(1)
...
def create_default_users():
    ...
    try:
        ...
        logger.info("=" * 60)
        logger.info("IMPORTANT: These are default credentials for testing!")
        logger.info("IMPORTANT: Change passwords in production environment!")
        logger.info("=" * 60)
