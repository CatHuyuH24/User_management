#!/usr/bin/env python3
"""
Script to create the default admin account for the User Management System.
This script must be run after the database is set up and the FastAPI service is running.
"""
...
app_dir = Path(__file__).parent.parent / "services" / "user-service" / "app"
...
def verify_admin_access():
    """Verify that the admin account can be authenticated."""
    
    print("\n🔍 Verifying admin account access...")
    ...
    try:
        ...
        if user and isinstance(user, User):
            ...
            print(f"   MFA Required: Check admin portal for MFA setup")
            return True
        else:
...
def main():
    """Main function to create admin account and verify access."""
